DELIMITER //
DROP PROCEDURE IF EXISTS SP_ArticleUserOneSelect //
CREATE PROCEDURE SP_ArticleUserOneSelect(v_user_id INT, v_article_slug VARCHAR(128))
BEGIN
